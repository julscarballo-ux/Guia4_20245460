...
const btnDividir = document.querySelector('idBtnDvidir');
...
function sumar () {
    let numero1=parseFloat(prompt("Ingrese el primero numero a sumar"));
...
function restar () {
    let numero1=parseFloat(prompt("Ingrese el primero numero a restar"));
...
function multiplicar () {
    let numero1=parseFloat(prompt("Ingrese el primero numero a multiplicar"));
...
function dividir () {
    let numero1=parseFloat(prompt("Ingrese el primero numero a dividir"));
